...
// message will be printed to the file out.txt
//-----------------------------------------------------------------------------
#include "tools.hpp"
...
int main( void ){
    ...
    for(;;){
        ...
        c = (d & 0xF8); //c = d most signif 5 bits of d with LS 3 bits set to 0
    ...
    cout << "Messaged Decypher and output to out.txt" << endl;
